(function ($) {
  ...
  $.ajaxSetup({
    ...
    $("body").on("click", ".delete", function () { 
      ...
      if (type == "spin") { link = link + "/luckywheel/delete/" + id; }
      ...
      else if (type == "onboarding") { link = link + "/setting/onboarding/delete/" + id; }
      else if (type == "subscriptions") { link = link + "/subscriptions/delete/" + id; }
      else if (type == "admin") { link = link + "/admin/delete/" + id; }
      else if (type == "nativead") { link = link + "/ads/native/delete/" + id; }
      else if (type == "referTask") { link = link + "/contest/delete/" + id; }
      else if (type == "social") { link = link + "/setting/social/delete/" + id; }
      else if (type == "homepagecat") { link = link + "/app-setting/homepage/category/delete/" + id; }
      else if (type == "homebtn") { link = link + "/app-setting/homepage/delete/" + id; }
    ...
    $("body").on("click",".dropdown-item",function(){
      ...
      else if(type=="videowall"){ url='/offerwall/videowall/action';}
      else if(type=="support"){ url='/support/action';}
      else if(type=="onboarding"){ url='/onboarding/action';}
      else if(type=="subscriptions"){ url='/subscriptions/action';}
      else if(type=="nativeAd"){ url='/ads/native/action';}
      else if(type=="referTask"){ url='/contest/action';}
      else if(type=="social" || type=="lang" || type=="gateway"){ url='/setting/action';}
      else if (type == "homepage") { url='/app-setting/homepage/action'; }
      else if (type == "homepagecat") { url='/app-setting/homepage/category/action'; }
