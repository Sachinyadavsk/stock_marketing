                                                ...
                                                <td class="text-sm">
                                                    <span class="my-2 text-xs">
                                                        <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#flow<?php echo $list['id']; ?>">
                                                            <img src="https://reapbucks.com/rb-admin/images/offers/<?php echo $list['icon_url']; ?>" style="width:100px;height:50px;">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">
                                                                <img src="https://reapbucks.com/rb-admin/images/offers/<?php echo $list['icon_url']; ?>" style="height: 20px;">
                                                                <?php echo $list['name']; ?>
                                                            </h5>
