<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
        ...
        <div class="sidenav-header">
            ...
            <a class="align-items-center d-flex m-0 navbar-brand text-wrap"
                href="https://reapbucks.com/userpanel/dashboard">
                <img src="assets/img/favicon.png" class="navbar-brand-img h-100"
                    alt="main_logo">
                <span class="ms-3 font-weight-bold">Welcome <?php echo $_SESSION['ADMIN_NAME'];?></span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="https://reapbucks.com/userpanel/dashboard" class="nav-link">
                        <div
                  ...
                  <!-- All Offers -->
                 <li class="nav-item">
                    <a href="https://reapbucks.com/userpanel/offers" class="nav-link">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                ...
                <!--hot offer -->
                <!-- <li class="nav-item">-->
                <!--    <a href="https://reapbucks.com/userpanel/hotoffer" class="nav-link">-->
                <!--        <div-->
                <!--            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">-->
                <!--            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">-->
                <!--            <title>office</title>-->
                ...
                <!--        </svg>-->
                <!--        </div>-->
                <!--        <span class="nav-link-text ms-1">Hot Offer</span>-->
                <!--    </a>-->
                <!--</li>-->
                
                <!-- My Earnings -->
                 <li class="nav-item">
                    <a href="https://reapbucks.com/userpanel/my_earnings" class="nav-link">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                           <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                     ...
                     <!-- my_payments -->
                 <li class="nav-item">
                    <a href="https://reapbucks.com/userpanel/wallet" class="nav-link">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                           <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                ...
                <!-- payment-details-->
                 <li class="nav-item">
                    <a href="https://reapbucks.com/userpanel/payment-details" class="nav-link">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                ...
                <!-- My Referrals-->
                 <li class="nav-item">
                    <a href="https://reapbucks.com/userpanel/my_referrals" class="nav-link">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                ...
                <!-- My leads-->
                <!-- <li class="nav-item">-->
                <!--    <a href="https://reapbucks.com/userpanel/leads.php" class="nav-link">-->
                <!--        <div-->
                <!--            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">-->
                <!--            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"-->
                <!--                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">-->
                ...
                <!-- admin setting -->
                <li class="nav-item">
                    <a href="https://reapbucks.com/userpanel/settings" class="nav-link">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
