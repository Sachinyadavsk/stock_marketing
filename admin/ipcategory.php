            ...
            <div class="container-xl">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-5 col-sm-12">
                        <form class="card px-0" method="post" action="game/ip/category/add">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="ip_category_name"
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="ip_category_col"
                                                placeholder="4" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="ip_category_row"
                                                placeholder="3" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="ip_category_time" placeholder="30"
                                            value="">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="ip_category_cost"
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="ip_category_reward"
                        ...
                        <div class="card card-body">
                            <a href="#" class="btn btn-block btn-dark" data-toggle="modal" data-target="#cat-update"
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="card fixed-img-height d-flex justify-content-center">
                                    <a href="game/ip?id=3" class="d-block text-center">
                                        <span class="h1">6 X 10</span><br>
                                    ...
                                    <div class="btns">
                                        ...
                                        <a href="#" class="btn-edit" data-id="3" data-title="Complex" data-cost="100"
                                            data-reward="200" data-time="2000" data-row="10" data-col="6"
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="card fixed-img-height d-flex justify-content-center">
                                    <a href="game/ip?id=1" class="d-block text-center">
                                        <span class="h1">5 X 6</span><br>
                                        <span class="h4">Basic Puzzle</span>
                                    </a>
                                    <div class="btns">
                                        ...
                                        <a href="#" class="btn-edit" data-id="1" data-title="Basic Puzzle"
                                            data-cost="150" data-reward="300" data-time="1600" data-row="6" data-col="5"
                                            data-toggle="modal" data-target="#cat-edit" data-backdrop="static"
                                            data-keyboard="false">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-md" width="24"
                                                height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                ...
                <form method="post" action="game/ip/category/del"
                ...
                <form method="post" action="game/ip/category/edit"
                ...
                <form method="post" action="game/ip/settings" class="modal modal-blur fade"
                        ...
                        <div class="modal-content card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="round" value="50">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary mr-auto"
