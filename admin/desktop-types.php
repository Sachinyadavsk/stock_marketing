...
<?php
	...
	logActivity($con, $last_id, $role_type_is, $version, 'Add new device version');
?>
        <script>
            Swal.fire({
              position: 'top-end',
...
if(isset($_GET['type']) && $_GET['type']!=''){
	...
	if($type=='delete'){
		...
		logActivity($con, $id, $role_type_is, $type, 'Delete device version');
		?>
    <script>
        Swal.fire({
          position: 'top-end',
            ...
            <div class="container-xl">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <h2 class="page-title">Desktop Version</h2>
                        </div>
                    </div>
                    
                     <?php if (has_module_access_insert($con, 'desktop_menu')): ?>
                    ...
                    <div class="box">
                        <div class="card">
                           <?php
                            ...
                            // Get total records
                            $total_res = mysqli_query($con, "SELECT COUNT(*) as total FROM device_version WHERE type='desktop'");
                            $total_row = mysqli_fetch_assoc($total_res);
                            $total_records = $total_row['total'];
                            $total_pages = ceil($total_records / $limit);
                            
                            $cat_res = mysqli_query($con, "SELECT * FROM device_version WHERE type='desktop' ORDER BY id DESC LIMIT $offset, $limit");
                            $cat_arr = array();
                            $i = $offset + 1;
                                ...
                                <table class="table table-vcenter table-mobile-sm card-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (has_module_access_delete($con, 'desktop_menu')): ?>
