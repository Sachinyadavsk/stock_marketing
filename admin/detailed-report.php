            ...
            <div class="container-xl">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <h2 class="page-title">Detailed Report</h2>
                        </div>
                    </div>
                     <?php if (has_module_access_insert($con, 'user_report')): ?>
                                    ...
                                    <tbody>
                                          <?php
                                                if(isset($_POST['filter-submit'])){
                                                  ...
                                                  $cat_res=mysqli_query($con,"select * from final_report $sql order by id desc");
                                                }
                                                $cat_arr=array();
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-muted text-nowrap" data-label="User Id">
